      ...
      <Box maxW="xs" mx="auto" bg="white" shadow="lg" rounded="lg">
        ...
        <Box p={3}>
          ...
          <Text mt={2} fontSize="sm" color="gray.600" noOfLines={3}>
            ...
            quidem sequi illum facere recusandae voluptatibuslksmflk jnaskjna
            aksnfak aksnfkaj aksjnka ajksnak sakjsfn a sfakjsnfa sfakjsnfak
            sfasnfa asnfa ajks fa fkjlnf nafbm, siunoajso
          </Text>
        </Box>
      </Box>
    </Flex>
